...
create table public.scores (
  ...
  created_at timestamptz default now(),
  -- Relación directa con profiles para que PostgREST pueda hacer el join
  -- profiles(username) en la consulta del ranking.
  constraint scores_user_id_profiles_fkey
    foreign key (user_id) references public.profiles(id) on delete cascade,
  -- Una sola fila por usuario y modo: guardamos solo su mejor marca.
...
create policy "Usuario actualiza sus propias puntuaciones"
