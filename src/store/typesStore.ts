...
/**
 * Estado del modo "Maestro de Tipos".
 * Es un modo APARTE: no toca el ranking ni la Pokédex de Supabase y mantiene
 * sus propias estadísticas en LocalStorage, separadas del juego principal (escribir Pokémon por tipos).
 */
